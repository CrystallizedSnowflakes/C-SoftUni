...
namespace _01.CountWorkingDays
{
    class CountWorkingDays
    {
        ...
        {
            DateTime startDate = DateTime.ParseExact(Console.ReadLine(), "dd-MM-yyyy", CultureInfo.InvariantCulture); //11-04-2016
            ...
            for (DateTime day = startDate; day <= endDate; day = day.AddDays(1))
            {
                ...
                if (!holidays.Contains(tempo) && day.DayOfWeek != DayOfWeek.Sunday && day.DayOfWeek != DayOfWeek.Saturday)
                {
                    counter++;
                }
            }
